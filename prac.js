...
import mlrImage from '../../assets/mlr2.avif';
import sdlcImage from '../../assets/SDLC.avif';
import backgroundImage from '../../assets/dashboard_bg.png';

function Dashboard({ activeButton, setActiveButton }) {
    return (
        <Container fluid 
            ...
            <h4 className="text-center" style={{ color: 'purple', marginTop: "3.5rem" }}>Welcome to Viatris Gen AI Platform</h4>
            <p className="text-center" style={{ color: 'purple', fontSize: '0.9rem' }}>THE AI TOOL TO HELP YOU GET YOUR WORK DONE.</p>

            <Row className="justify-content-center mt-2 w-100 d-flex">
                <Col md={4} className="d-flex justify-content-center mb-2">
                    <Link to="/mlr-upload" className="text-decoration-none" onClick={() => setActiveButton('mlr-upload')}>
                        <Card className={`shadow ${activeButton === 'mlr-upload' ? 'border border-primary' : ''}`} 
                            style={{ width: '20rem', marginBottom: "1.5rem", transition: 'transform 0.3s ease-in-out' }}
                            onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'}
                            onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}>

                            <Card.Body className="text-center">
                                <p style={{ color: 'purple', fontSize: '0.9rem' }}>Upload the Promo Material for MLR</p>
                                <Card.Img variant="top" src={mlrImage} alt="MLR" className="img-fluid rounded" />
                                <Button 
                                    style={{ backgroundColor: 'purple', borderColor: 'purple', transition: 'background-color 0.3s ease-in-out' }}
                                    className=" mt-3"
                                    >
                                    MLR Review
                                </Button>
                ...
                <Col md={4} className="d-flex justify-content-center mb-2">
                    <Link to="/sdlc-upload" className="text-decoration-none" onClick={() => setActiveButton('sdlc-upload')}>
                        <Card className={`shadow ${activeButton === 'sdlc-upload' ? 'border border-primary' : ''}`} 
                            style={{ width: '20rem', marginBottom: "1.5rem", transition: 'transform 0.3s ease-in-out' }}
                            onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'}
                            onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}>
                            <Card.Body className="text-center">
                                <p style={{ color: 'purple', fontSize: '0.9rem' }}>Agile Development Framework</p>
                                <Card.Img variant="top" src={sdlcImage} alt="SDLC" className="img-fluid rounded" />
                                <Button 
                                    style={{ backgroundColor: 'purple', borderColor: 'purple', transition: 'background-color 0.3s ease-in-out' }}
                                    className="mt-3"
                                 >
